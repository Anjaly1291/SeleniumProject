...
public class Length_Inchfoot {
	...
	public void Inch_Foot() {
		try {
			...
			String par1Val = ws.getRow(37).getCell(2).getStringCellValue();
			String dropdown1 = ws.getRow(38).getCell(1).getStringCellValue();
			String dropdown1Val = ws.getRow(38).getCell(2).getStringCellValue();
			String dropdown2 = ws.getRow(39).getCell(1).getStringCellValue();
			String dropdown2Val = ws.getRow(39).getCell(2).getStringCellValue();
