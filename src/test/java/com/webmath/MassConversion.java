	...
	public class Length_Inchfoot {
		...
		public void kg_gm() {
			try {
				...
				String Mass = ws.getRow(41).getCell(1).getStringCellValue();

				String par1 = ws.getRow(42).getCell(1).getStringCellValue();
				String par1Val = ws.getRow(42).getCell(2).getStringCellValue();
				String dropdown1 = ws.getRow(43).getCell(1).getStringCellValue();
				String dropdown1Val = ws.getRow(43).getCell(2).getStringCellValue();
				String dropdown2 = ws.getRow(44).getCell(1).getStringCellValue();
				String dropdown2Val = ws.getRow(44).getCell(2).getStringCellValue();
				String Convert = ws.getRow(45).getCell(1).getStringCellValue();

				driver.findElement(By.cssSelector(Mass)).click();
