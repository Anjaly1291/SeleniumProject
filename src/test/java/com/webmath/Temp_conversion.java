...
public class Temp_conversion {
	...
	public void hp_watt() {
		try {
			...
			String Temp = ws.getRow(66).getCell(1).getStringCellValue();

			String par1 = ws.getRow(67).getCell(1).getStringCellValue();
			String par1Val = ws.getRow(67).getCell(2).getStringCellValue();
			String dropdown1 = ws.getRow(68).getCell(1).getStringCellValue();
			String dropdown1Val = ws.getRow(68).getCell(2).getStringCellValue();
			String dropdown2 = ws.getRow(69).getCell(1).getStringCellValue();
			String dropdown2Val = ws.getRow(69).getCell(2).getStringCellValue();
			String Convert = ws.getRow(70).getCell(1).getStringCellValue();
