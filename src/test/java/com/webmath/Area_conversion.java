...
public class Area_conversion {
	...
	public void sqm_sqcm() {
		try {
			...
			String Area = ws.getRow(46).getCell(1).getStringCellValue();

			String par1 = ws.getRow(47).getCell(1).getStringCellValue();
			String par1Val = ws.getRow(47).getCell(2).getStringCellValue();
			String dropdown1 = ws.getRow(48).getCell(1).getStringCellValue();
			String dropdown1Val = ws.getRow(48).getCell(2).getStringCellValue();
			String dropdown2 = ws.getRow(49).getCell(1).getStringCellValue();
			String dropdown2Val = ws.getRow(49).getCell(2).getStringCellValue();
			String Convert = ws.getRow(50).getCell(1).getStringCellValue();
