	...
	public class Length_Inchfoot {
		...
		public void Inch_Inch() {
			try {
				...
				String par1Val = ws.getRow(37).getCell(4).getStringCellValue();
				String dropdown1 = ws.getRow(38).getCell(1).getStringCellValue();
				String dropdown1Val = ws.getRow(38).getCell(4).getStringCellValue();
				String dropdown2 = ws.getRow(39).getCell(1).getStringCellValue();
				String dropdown2Val = ws.getRow(39).getCell(4).getStringCellValue();
